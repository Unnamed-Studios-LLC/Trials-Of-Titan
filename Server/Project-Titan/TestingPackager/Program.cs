...
namespace TestingPackager
{
    class Program
    {
        static void Main(string[] args)
        {
            string worldPath = "../Testing.World";
            string webServerPath = "../Testing.WebServer";
        ...
        private static async void DoTransfer(string worldZip, string webZip, ManualResetEvent resetEvent)
        {
            ...
            await fileTransfer.UploadAsync(worldZip, "trials-of-titan", "game-server/testing/world.zip");

            Log.Write("Transfering webserver...");

            await fileTransfer.UploadAsync(webZip, "trials-of-titan", "game-server/testing/webserver.zip");
