...
namespace World.Logic.Actions.Movement
{
    ...
    public class Chase : LogicAction<ChaseValue>
    {
        /// <summary>
        /// The speed to chase the play at
        /// </summary>
        private float speed;
        ...
        public override void Init(Entity entity, out ChaseValue obj, ref StateContext context, ref WorldTime time)
        {
            obj = new ChaseValue();
            searchCooldown.Init(out obj.cooldownValue);
        }

        public override void Tick(Entity entity, ref ChaseValue obj, ref StateContext context, ref WorldTime time)
        {
            ...
            var vector = obj.target.position.Value - notPlayable.position.Value;
